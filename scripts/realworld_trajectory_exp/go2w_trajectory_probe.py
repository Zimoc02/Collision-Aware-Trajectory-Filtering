#!/usr/bin/env python3
"""Trajectory experiment runner for Go2W + InternNav.

This file lives in an experiment-only folder so the working discrete-action
deployment remains untouched. By default it probes trajectory output and saves
results. It only executes motion when --execute is supplied.
"""
...
def main():
    ...
    try:
        ...
        for step in range(args.steps):
            ...
            actions = response.get("discrete_action") or response.get("discrete_action_fallback") or []
