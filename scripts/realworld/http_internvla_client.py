...
frame_data = {}
frame_idx = 0
SERVER_URL = os.environ.get('INTERNVLA_SERVER_URL', 'http://127.0.0.1:5801/eval_dual')
# user-specific
...
def dual_sys_eval(image_bytes, depth_bytes, front_image_bytes, url=SERVER_URL):
